...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SweatSheet.Server.Modules.Auth.Entities.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("SweatSheet.Server.Modules.Exercise.Entities.Exercise", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SweatSheet.Server.Modules.Workouts.Entities.WorkoutActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("SweatSheet.Server.Modules.Auth.Entities.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SweatSheet.Server.Modules.Auth.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SweatSheet.Server.Modules.Workouts.Entities.Workout", b =>
                {
                    b.HasOne("SweatSheet.Server.Modules.Auth.Entities.ApplicationUser", "User")
                        .WithMany("Workouts")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SweatSheet.Server.Modules.Workouts.Entities.WorkoutActivity", b =>
                {
                    b.HasOne("SweatSheet.Server.Modules.Exercise.Entities.Exercise", "Exercise")
                        .WithMany()
